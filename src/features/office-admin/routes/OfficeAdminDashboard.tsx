        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white/80 rounded-2xl shadow-lg ring-1 ring-slate-200 p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/purchase-orders" className="text-sm text-blue-600 hover:underline">Open</Link>
            </div>
          ...
          <div className="bg-white/80 rounded-2xl shadow-lg ring-1 ring-slate-200 p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/lpo-management" className="text-sm text-blue-600 hover:underline">Open</Link>
            </div>
          ...
          <div className="bg-white/80 rounded-2xl shadow-lg ring-1 ring-slate-200 p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/receiving-oversight" className="text-sm text-blue-600 hover:underline">Open</Link>
            </div>
            <div className="grid grid-cols-3 gap-4 mb-6">
