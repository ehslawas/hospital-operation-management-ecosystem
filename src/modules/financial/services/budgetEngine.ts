...
export async function getUnifiedBudgetSummary(
  ...
  try {
    ...
    // pooledPOs  â†’ ALL POs in the shared department group (for balance)
    // specificPOs â†’ ONLY POs from the exact selected department (for card display + list)
    // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    ...
    // Pooled expenses â†’ used ONLY for balance and usage % (shared pool perspective)
    ...
    // Specific expenses â†’ used for the Total Expenses card, liabilities, net expenses
...
export async function getExpenseList(
  ...
  try {
    ...
    // Filter in-memory with normalization â€” EXACT department match for unit-specific list
