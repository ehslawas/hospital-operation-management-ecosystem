  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500">{language === 'ms' ? 'Sistem Perolehan Hospital' : 'Hospital Procurement System'}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center">
        ...
        >
          {language === 'ms' ? 'Pergi ke Dashboard Perolehan' : 'Go to Procurement Dashboard'}
        </button>
      </div>
    </div>
  )
