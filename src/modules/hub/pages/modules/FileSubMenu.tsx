...
export const FileSubMenu: React.FC = () => {
    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-slate-900">MyFile</h1>
            <p className="text-slate-500">{language === 'ms' ? 'Pengurusan Fail & Dokumen' : 'Document & File Management'}</p>
          </div>
        </div>
      </div>
