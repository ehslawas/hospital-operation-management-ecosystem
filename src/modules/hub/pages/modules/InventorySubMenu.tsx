...
export const InventorySubMenu: React.FC = () => {
    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-slate-900">MyInventory</h1>
            <p className="text-slate-500">{language === 'ms' ? 'Pengurusan Inventori' : 'Inventory Management'}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center">
        ...
        >
          {language === 'ms' ? 'Pergi ke Dashboard Inventori' : 'Go to Inventory Dashboard'}
        </button>
      </div>
    </div>
  )
