...
export default function DischargeNotesPage() {
  ...
  const currentUser = {
    id: 'MO34567',
    name: 'Dr. Azman Hashim',
    designation: 'Medical Officer',
    fullName: 'Dr. Azman Hashim (MO34567)'
  };
  ...
  const [formData, setFormData] = useState({
    ...
    secondaryDiagnosis: '',
    hospitalCourse: 'Patient admitted with acute gastroenteritis and moderate dehydration. Managed with IV hydration and antiemetics. Condition improved, tolerating oral feeds well. No fever for past 24 hours.',
    conditionOnDischarge: 'Improved',
    dischargeMedications: '1. Syp Zinc 10mg OD x 10 days\n2. Syp Paracetamol 120mg PRN fever\n3. ORS solution as needed',
    followUpInstructions: '- Follow up at Paediatric OPD in 3 days\n- Watch for signs of dehydration: decreased urine, dry lips, lethargy\n- Continue oral rehydration\n- Return immediately if persistent vomiting, high fever, or decreased consciousness',
    nextTcaDate: '',
    nextTcaFacility: '',
  ...
  const handleComplete = () => {
    ...
    router.push(`/paediatric-ward/patient/${patientId}`);
  };
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="bg-gradient-to-br from-cyan-600 to-blue-700 p-3 rounded-xl shadow-lg">
        ...
        <div className="space-y-6">
          ...
          <Card className="shadow-lg border-cyan-200">
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-gradient-to-br from-cyan-50 to-blue-100 rounded-xl border border-cyan-200">
                <div>
                  <div className="text-xs font-semibold text-cyan-700 mb-1">Patient Name</div>
                  <div className="font-bold text-cyan-900">{patient.name}</div>
                </div>
                <div>
                  <div className="text-xs font-semibold text-cyan-700 mb-1">IC Number</div>
                  <div className="font-bold text-cyan-900">{patient.ic}</div>
                </div>
                <div>
                  <div className="text-xs font-semibold text-cyan-700 mb-1">Age / Gender</div>
                  <div className="font-bold text-cyan-900">{patient.age} / {patient.gender}</div>
                </div>
                <div>
                  <div className="text-xs font-semibold text-cyan-700 mb-1">Admission Date</div>
                  <div className="font-bold text-cyan-900">{patient.admissionDate}</div>
                </div>
                <div>
                  <div className="text-xs font-semibold text-cyan-700 mb-1">Ward</div>
                  <div className="font-bold text-cyan-900">{patient.ward}</div>
                </div>
                <div>
                  <div className="text-xs font-semibold text-cyan-700 mb-1">Bed</div>
                  <div className="font-bold text-cyan-900">{patient.bed}</div>
                </div>
                <div className="col-span-2">
                  <div className="text-xs font-semibold text-cyan-700 mb-1">Attending Doctor</div>
                  <div className="font-bold text-cyan-900">{patient.doctor}</div>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select 
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg text-base focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
          ...
          <div className="flex items-center justify-end gap-3 pb-8 print:hidden">
            <Link href={`/paediatric-ward/patient/${patientId}`}>
