    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-slate-900">MyPriviledging</h1>
            <p className="text-slate-500">Priviledging & Credentialing</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center">
        ...
        <button 
          ...
          className="mt-6 px-6 py-2 bg-lime-600 text-white rounded-lg hover:bg-lime-700 transition-colors"
        >
