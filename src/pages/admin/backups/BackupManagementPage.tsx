    ...
    <div className="space-y-6">
      ...
      >
        <StatCard
          ...
          subtitle={
            latestBackup
              ? `${formatFileSize(latestBackup.file_size || 0)} • ${getRelativeTime(latestBackup.completed_at || latestBackup.created_at)}`
              : 'No backups yet'
          }
          icon={Database}
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              <li>• Scheduled backups run daily at 2:00 AM</li>
              <li>• Backups are retained for 30 days</li>
              <li>• Manual backups can be created at any time</li>
              <li>• Backups include full database and system configuration</li>
              <li>• Download backups for offline storage or migration</li>
            </ul>
          </div>
        </div>
      </motion.div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-slate-50 rounded-lg p-4">
            ...
            <ul className="text-sm text-slate-600 space-y-1">
              ...
              <li>• Hospital and department data</li>
            </ul>
          </div>
