...
const mapJawatanToRole = (jawatan: string): string[] => {
  ...
  if (jawatanLower.includes('farmasi') || jawatanLower.includes('pharmacy') || jawatanLower.includes('pharmacist')) {
    ...
    if (jawatanLower.includes('penolong') || jawatanLower.includes('assistant') || jawatanLower.includes('pembantu')) return ['pharmacy_assistant']
    return ['pharmacist', 'pharmacy_assistant']
  }
