              ...
              <div className="flex flex-wrap bg-slate-100/80 p-1 rounded-2xl w-fit max-w-full border border-slate-200">
                ...
                >
                  <div className="flex items-center justify-center sm:justify-start gap-2 whitespace-nowrap">
                    <span className={activeTab === 'PO' ? 'text-indigo-500' : ''}>●</span>
                    Purchase Order
                  </div>
                </button>
                ...
                >
                  <div className="flex items-center justify-center sm:justify-start gap-2 whitespace-nowrap">
                    <span className={activeTab === 'MANUAL' ? 'text-amber-500' : ''}>●</span>
                    Manual PO
                  </div>
                </button>
                ...
                >
                  <div className="flex items-center justify-center sm:justify-start gap-2 whitespace-nowrap">
                    <span className={activeTab === 'SQ' ? 'text-emerald-500' : ''}>●</span>
                    Invite Quotation
                  </div>
                </button>
              </div>
                          ...
                          >
                            ...
                            <td className="px-5 py-3.5 text-right">
                              <div className="text-sm font-black text-slate-900 tabular-nums">
                                {formatCurrency(order.total_amount).replace('MYR', '').trim()}
                              </div>
                            </td>
                        ...
                        >
                          ...
                          <div className="grid grid-cols-2 gap-4 mb-3">
                            ...
                            <div className="space-y-0.5">
                              ...
                              <p className="text-xs font-black text-slate-900 tabular-nums">{formatCurrency(order.total_amount)}</p>
                            </div>
                          </div>
