...
export const IssueToDepartment: React.FC = () => {
    ...
    return (
        <div className="space-y-6 animate-fade-in p-6 bg-slate-50/20 min-h-screen">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex gap-2 w-full md:w-auto">
                    <Button variant="outline" className="flex-1 md:flex-none border-slate-300 text-slate-700 font-black h-11 px-6 rounded-xl hover:bg-slate-50" onClick={() => setIsCreateModalOpen(true)}>
