    ...
    <div className="space-y-6 p-6">
      ...
      <div className="border-b border-gray-200 pb-4">
        <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
          ...
          Clinic Facility Catalog
        </h1>
        <p className="text-gray-600 mt-1">
          Manage list of clinics in Malaysia • {facilities.length} clinic{facilities.length !== 1 ? 's' : ''}
        </p>
      </div>
      ...
      {isLoading ? (
        <div className="bg-white rounded-2xl border-2 border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-600 mt-4">Loading clinic facilities...</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border-2 border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-600 mb-4">
            {searchQuery || stateFilter !== 'all' || cityFilter !== 'all' || statusFilter !== 'all'
              ...
              : 'Click "Add Clinic" to add a new clinic facility'}
          </p>
          <Button
            onClick={() => {
              setSelectedFacility(null)
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b-2 border-gray-200">
                <tr>
                  ...
                  >
                    Clinic Name {sortConfig.key === 'name' && (sortConfig.direction === 'asc' ? '↑' : '↓')}
                  </th>
