        ...
        <div className="px-8 py-3 border-b-2 border-gray-800 bg-gray-50">
          ...
          <div className="grid grid-cols-1 gap-2">
            <div className="border border-gray-600 p-2 bg-white">
              ...
              <p className="text-sm font-semibold text-gray-900 uppercase">{order.supplier?.company_name || 'ΓÇö'}</p>
            </div>
                ...
                <tbody>
                  {items.map((item, index) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      ...
                      <td className="border border-gray-600 px-2 py-1.5 text-xs text-gray-900">{item.item_name || 'ΓÇö'}</td>
                      <td className="border border-gray-600 px-2 py-1.5 text-xs text-gray-700 font-mono">{item.item_code || 'ΓÇö'}</td>
                      ...
                      <td className="border border-gray-600 px-2 py-1.5 text-xs text-gray-700">{item.packaging_description || 'ΓÇö'}</td>
                    </tr>
                  ))}
            ...
            <div className="w-full md:w-96 space-y-1.5 border-2 border-gray-600 p-2.5 bg-white ml-auto">
              <div className="flex justify-between items-center border-b border-gray-400 pb-1">
                ...
                <span className="text-sm font-bold text-gray-900">
                  {balance !== null ? formatCurrency(balance + total) : 'ΓÇö'}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center pt-1">
                ...
                <span className="text-base font-bold text-gray-900">
                  {balance !== null ? formatCurrency(balance) : 'ΓÇö'}
                </span>
              </div>
            </div>
          </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="border border-gray-800 px-3 py-1.5 font-bold text-sm uppercase" style={{ lineHeight: '1.3' }}>
                    {order.supplier?.company_name || 'ΓÇö'}
                    <br />
