                            ...
                            <div key={idx} className={`bg-white rounded-xl border border-slate-200 p-4 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group ${config.accentColor} border-l-4`}>
                                <div className="flex justify-between items-start mb-2">
                                    ...
                                    <Badge variant="gray" className="bg-slate-50 text-slate-500 text-[10px] font-mono group-hover:bg-indigo-50 group-hover:text-indigo-600 transition-colors">
                                        {stats.verifiedBalance + stats.verifiedEmpty} / {stats.balance + stats.empty} Found
                                    </Badge>
                                </div>
                                <div className="flex items-end gap-2 mt-2">
                                    <span className="text-2xl font-bold text-slate-900">{stats.verifiedBalance}</span>
                                    <span className="text-[10px] font-bold text-slate-400 mb-1 uppercase tracking-tighter">Verified Avail</span>
                                </div>
                                <div className="mt-3 flex items-center gap-2 text-[10px] font-medium text-slate-400">
                                    <span className={cn(stats.balance > 0 ? "text-slate-500 font-bold" : "text-slate-300")}>{stats.balance} System Avail</span>
                                    <span className="w-1.5 h-1.5 rounded-full bg-slate-200" />
                                    <span>{stats.usage}/mo</span>
                                </div>
                            </div>
                        )
                    })}
                                        ...
                                        <div className="p-5 flex-1 flex flex-col">
                                            <div className="flex justify-between items-start mb-4">
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <span className="text-[10px] text-slate-400 font-medium uppercase">Verified / {totalCount}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="space-y-1.5 mb-6">
                                                <div className="flex justify-between text-xs font-medium">
                                                    <span className="text-emerald-600">{verifiedCount} Scanned</span>
