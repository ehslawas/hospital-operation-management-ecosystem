...
`}</style>
      <div className="p-4 space-y-4 max-w-7xl mx-auto print-content bg-gray-100 min-h-screen">
        ...
        {/* Professional Government Document View - Screen - HIDDEN (Replaced by Cards) */}
      ...
      <div className={`print-labels-container hidden print:hidden ${isPrintingLabels ? 'print-labels-grid' : ''}`}>
        {items.map((item, index) => (
          <OxyIdentityCard
            key={`print-${item.id}`}
            itemName={item.item_name || 'Unknown Item'}
